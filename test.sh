...
tail -f /tmp/srv-input | python3 client.py 127.0.0.1 > test_files/client1_output.txt &
printf 'c\n|\nash\n' > /tmp/srv-input
sleep 1
printf 'u\nash\nc\ncharles\n2\nash\n2\nb\n2\n*.\n3\nash\nhello!\n2\n\nexit\n' | python3 client.py 127.0.0.1 > test_files/client2_output.txt &
PID3=$!
sleep 1
printf 'exit\n' > /tmp/srv-input
sleep 1
printf 'u\nbob\nu\nash\n3\ncharles\ngoodbye\n3\nlol\ninvalid account\n4\n' | python3 client.py 127.0.0.1 > test_files/client3_output.txt &
PID4=$!
sleep 1
printf 'u\ncharles\nexit\n' | python3 client.py 127.0.0.1 > test_files/client4_output.txt &
PID5=$!
sleep 1
